...
## Advanced options
Once the subgroup column is created, users can further cusotimize group labels from "true" or "false" to for exmaple "wild type" or "EGFR mutant" by adjusting the column display settings.
